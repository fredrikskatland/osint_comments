<template>
  <div class="analysis">
    ...
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Analyze Comments</h5>
        <form @submit.prevent="analyzeComments">
          <div class="mb-3">
            ...
            <div class="form-text">Identifier for a specific article (leave empty to analyze all articles)</div>
          </div>
          <div class="mb-3">
            <label for="limit" class="form-label">Limit</label>
            <input type="number" class="form-control" id="limit" v-model="limit" min="1">
            <div class="form-text">Maximum number of comments to analyze (leave empty for all)</div>
          </div>
    ...
    <div class="mt-4">
      <div class="card mb-3">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0">Flagged Comments</h5>
      ...
      <comment-list :articleId="viewArticleId" :flaggedOnly="true" :limit="commentsPerPage" />
    </div>
  ...
  methods: {
    async analyzeComments() {
      ...
      try {
        ...
        // If analyzing for a specific article, update the view to show those comments
        if (this.articleId) {
